...
CADDYIndexPage=https://github.com/vernme/wzdzxmdd/raw/main/3DCEList-master.zip
...
StoreFiles=https://raw.githubusercontent.com/vernme/errwayok/master/etc/StoreFiles
#PORT=4433
